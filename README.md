...
Then set it as default. The System Settings GUI picker can be stale/cached
even after this — the reliable way is the modern `NSWorkspace` API:
...
## Customizing the browser list

Edit `candidateBrowsers` at the top of `Sources/LinkChoice/main.swift`:
